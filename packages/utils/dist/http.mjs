...
function settle(resolve, reject, response2) {
  ...
  if (!response2.status || !validateStatus2 || validateStatus2(response2.status)) {
    ...
    reject(new AxiosError$1("Request failed with status code " + response2.status, [AxiosError$1.ERR_BAD_REQUEST, AxiosError$1.ERR_BAD_RESPONSE][Math.floor(response2.status / 100) - 4], response2.config, response2.request, response2));
  }
}
...
const fetchAdapter = isFetchSupported && (async (config) => {
  ...
  try {
    ...
    if (supportsResponseStream && (onDownloadProgress || isStreamResponse && unsubscribe)) {
      ...
      response2 = new Response(trackStream(response2.body, DEFAULT_CHUNK_SIZE, onProgress, () => {
        flush && flush();
...
class HttpCore {
   ...
   * @param paramsData
   */
  get(requestUrl, paramsData) {
    if (!checkRequestUrl(requestUrl)) ;
    return axios.get(requestUrl, paramsData);
  }
  /**
   * post请求
   * @param requestUrl
   ...
   * @param headers
   */
  post(requestUrl, paramsData, headers) {
    if (!checkRequestUrl(requestUrl)) ;
    return axios.post(requestUrl, paramsData, headers);
  }
}
const httpCore = new HttpCore();
class HttpFnStore {
  constructor() {
    _defineProperty(this, "beforeFnList", void 0);
    _defineProperty(this, "afterFnList", void 0);
    _defineProperty(this, "errorFnList", void 0);
    _defineProperty(this, "finallyFnList", void 0);
    this.beforeFnList = [];
    this.afterFnList = [];
    this.errorFnList = [];
    this.finallyFnList = [];
...
const httpFnStore = new HttpFnStore();
function beforeMethod(url, data, options, beforeFnList) {
...
function finallyMethod(url, data, options, resp, finallyFnList) {
...
function httpFlow(url, data, options, httpFn) {
  ...
  return beforeMethod(url, data, options, beforeFnList).then(function() {
...
const getUrlPrefix = function(optUrlPrefix, urlPrefix) {
  return optUrlPrefix || urlPrefix;
};
class Http {
  constructor(urlPrefix, mockUrlPrefix) {
    _defineProperty(this, "urlPrefix", void 0);
    _defineProperty(this, "mockUrlPrefix", void 0);
   ...
   * @returns {*}
   */
  getRequestUrl(isCustomUrl, requestUrl, options) {
    ...
    return Object.assign(
      {
        ...
        isLoading: false,
        customUrl: false,
        useUserCacheInfo: true,
        // 使用用户缓存信息
        errorExitAndCloseLoading: true,
        // 接口报错自动关闭loading
   ...
   * @param options
   */
  compatibleOldInterface(params, options = {}) {
    const mergedOptions = this.mergeDefaultOptions(options);
    const safeParams = params || {};
    const isOptions = (obj) => obj && typeof obj === "object";
    const primitive = isOptions(safeParams) ? safeParams.primitive : void 0;
    const urlPrefix = isOptions(safeParams) ? safeParams.urlPrefix : void 0;
    const isLoading = isOptions(safeParams) ? safeParams.isLoading : void 0;
    const openCustomError = isOptions(safeParams) ? safeParams.openCustomError : void 0;
    const openExpire = isOptions(safeParams) ? safeParams.openExpire : void 0;
    const autoInteract = isOptions(safeParams) ? safeParams.autoInteract : void 0;
    const customUrl = isOptions(safeParams) ? safeParams.customUrl : void 0;
    const useUserCacheInfo = isOptions(safeParams) ? safeParams.useUserCacheInfo : void 0;
    const errorExitAndCloseLoading = isOptions(safeParams) ? safeParams.errorExitAndCloseLoading : void 0;
    const firstMockData = isOptions(safeParams) ? safeParams.firstMockData : void 0;
    const backupMockData = isOptions(safeParams) ? safeParams.backupMockData : void 0;
    const compatibleOptions = {
      primitive: primitive !== null && primitive !== void 0 ? primitive : mergedOptions.primitive,
      urlPrefix: urlPrefix !== null && urlPrefix !== void 0 ? urlPrefix : mergedOptions.urlPrefix,
      isLoading: isLoading !== null && isLoading !== void 0 ? isLoading : mergedOptions.isLoading,
      openCustomError: openCustomError !== null && openCustomError !== void 0 ? openCustomError : mergedOptions.openCustomError,
      openExpire: openExpire !== null && openExpire !== void 0 ? openExpire : mergedOptions.openExpire,
      autoInteract: autoInteract !== null && autoInteract !== void 0 ? autoInteract : mergedOptions.autoInteract,
      customUrl: customUrl !== null && customUrl !== void 0 ? customUrl : mergedOptions.customUrl,
      useUserCacheInfo: useUserCacheInfo !== null && useUserCacheInfo !== void 0 ? useUserCacheInfo : mergedOptions.useUserCacheInfo,
      errorExitAndCloseLoading: errorExitAndCloseLoading !== null && errorExitAndCloseLoading !== void 0 ? errorExitAndCloseLoading : mergedOptions.errorExitAndCloseLoading,
      backupMockData: backupMockData !== null && backupMockData !== void 0 ? backupMockData : mergedOptions.backupMockData,
      firstMockData: firstMockData !== null && firstMockData !== void 0 ? firstMockData : mergedOptions.firstMockData
    };
   ...
   * 调用MOCK接口数据
   */
  callMockData(requestUrl, params, options = {}, headers = {}) {
    const tempRequestUrl = this.getRequestUrl(true, this.mockUrlPrefix + requestUrl, this.mergeDefaultOptions(options));
    return httpFlow(requestUrl, params, this.mergeDefaultOptions(options), () => {
 ...
 服务地址：${tempRequestUrl}`, "color:red;font-size:12px");
   ...
   *
   */
  post(requestUrl, params, options = {}, headers) {
    const safeParams = this.disposeProps(params);
    const safeOptions = this.disposeProps(options);
    const mergedOptions = this.compatibleOldInterface(safeParams, safeOptions);
    ...
    if (mergedOptions.backupMockData) {
      return httpFlow(requestUrl, safeParams, mergedOptions, () => {
  ...
  get(requestUrl, params, options = {}) {
    ...
    const mergedOptions = this.compatibleOldInterface(safeParams, safeOptions);
    const tempRequestUrl = this.getRequestUrl(mergedOptions.customUrl, requestUrl, mergedOptions);
    return httpCore.get(tempRequestUrl, safeParams).then((responseData) => {
      return responseData.data;
    });
  }
}
class httpEnhancer extends Http {
  constructor(urlPrefix, mockUrlPrefix) {
    super(urlPrefix, mockUrlPrefix);
    _defineProperty(this, "addBeforePlug", (plug) => {
      this.addBeforeFn(plug);
      return this;
    });
    _defineProperty(this, "addAfterPlug", (plug) => {
      this.addAfterFn(plug);
      return this;
    });
    _defineProperty(this, "addErrorPlug", (plug) => {
      this.addErrorFn(plug);
      return this;
    });
    _defineProperty(this, "addFinallyPlug", (plug) => {
...
const parameter = (callback) => {
  return ({
    data
  }) => {
    data.uuid = v4().replace(/-/g, "");
